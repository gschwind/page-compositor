...
std::shared_ptr<pixmap_t> simple2_theme_t::
create_background_image(unsigned width, unsigned height) const {

	cairo_surface_t * tmp = cairo_image_surface_create_from_png(
			background_file.c_str());

	std::shared_ptr<pixmap_t> background = make_shared<pixmap_t>(width, height);

	cairo_surface_t * image_background_s = background->get_cairo_surface();

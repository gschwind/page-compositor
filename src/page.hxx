...
class page_t : public page_context_t, public display_compositor_t {
	...
	weak_ptr<xdg_surface_toplevel_t> _net_active_window;
...
public:
	...
	virtual void set_focus(shared_ptr<xdg_surface_toplevel_t> w, xcb_timestamp_t tfocus);
